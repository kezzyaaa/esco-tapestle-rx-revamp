...
(function ($) {
  ...
  $(window).on('scroll', function () {
    ...
    if (scroll < 300) {
      ...
      $("#navigation-logo").removeClass("nav-brand-bottom"); // $("#navigation-logo").fadeOut(500);

      $('#floating-social-icons').removeClass("vis");
    } else {
      $("#sticky-header").addClass("sticky");
      $("#navigation-logo").removeClass("nav-brand-top");
      $("#navigation-logo").addClass("nav-brand-bottom"); // $("#navigation-logo").fadeIn(500);
  ...
  browserWindow.on('load', function () {
    ...
    function covidPopupClose() {
      ...
      var covidpopup = getCookie("covidpopup"); // console.log('test');
    ...
    function checkCookie() {
      ...
      if (covidpopup != "") {// alert("Welcome again " + user);
      } else {// $(".overlay-img").fadeIn();
        // $(".landing-page-popup").fadeIn();
      }

      if (subscription != "") {// alert("Welcome again " + user);
      } else {
        setTimeout(function () {
          subscriptionPopup(); // setCookie("username", 'user', 100000);
        }, 6000); // user = prompt("Please enter your name:","");
        // if (user != "" && user != null) {
        // }
      }

      if (cookieConsent != "") {// alert("Welcome again " + user);
      } else {
        setTimeout(function () {
          cookieConsentpopup(); // setCookie("username", 'user', 100000);
        }, 2000); // user = prompt("Please enter your name:","");
        // if (user != "" && user != null) {
        // }
      }
    }
    ...
    $("#newsletterpopup a.popup-subscribe").on('click', function (event) {// email_subscribepopup()
    });

    function popupClosedByUser() {
      // get the mPopup
      popupClose(); // setCookie("subscription", 'subscription', 7);
    }

    function popupClose() {
      // get the mPopup
      var mpopup = $('#newsletterpopup');
      setCookie("subscription", 'subscription', 7); // open the mPopup
    ...
    function subscriptionPopup() {
      // get the mPopup
      var mpopup = $('#newsletterpopup'); // open the mPopup
  ...
  $(document).ready(function () {
    ...
    new WOW().init(); // :: 3.0 Nav Active Code
    ...
    $("#cf7_controls").on('mouseover', '.hoverable-solutions p', function () {
      $("#cf7 div").removeClass("opaque"); // var newImage = $(this).index();
    ...
    $('#solution-carousel').owlCarousel((_$$owlCarousel = {
      stagePadding: 220,
      center: true,
      loop: true,
      margin: 0,
    ...
    $("a.product_spec_link").on('click', function (event) {
      ...
      if ($(this).attr("data-link") !== "") {
        ...
        var hash = $(this).attr("data-link"); // Using jQuery's animate() method to add smooth page scroll
...
__webpack_require__(/*! C:\Users\ysrael.jacinto\Documents\Esco Projects\escotapestlrx-clone\revamped.escotapestlerx\esco-tapestle-rx-revamp\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\Users\ysrael.jacinto\Documents\Esco Projects\escotapestlrx-clone\revamped.escotapestlerx\esco-tapestle-rx-revamp\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\Users\ysrael.jacinto\Documents\Esco Projects\escotapestlrx-clone\revamped.escotapestlerx\esco-tapestle-rx-revamp\resources\sass\admin.scss */"./resources/sass/admin.scss");
