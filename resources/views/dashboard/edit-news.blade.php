...
@section('content')
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="m-4 m-md-5 mt-5">
            ...
            <form action="/dashboard/news/{{$news->id}}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('PATCH')
                <div class="form-group">
                    <label for="title"><strong>Title</strong></label>
                    <input type="text" name="title" required id="title" value="{{old('title') ?? $news->title}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <textarea  type="text" name="description" required class="form-control" rows="3">{{old('description') ?? $news->description}}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="news_category_id" required id="news_category_id" class="form-control">
                      @foreach ($newsCategories as $newsCategory)
                        <option value="{{$newsCategory->id}}" {{ $newsCategory->id == $news->news_category_id? 'selected':''}}>{{$newsCategory->title}}</option>
                      @endforeach
                </select>
                </div>

                <div class="form-group mt-4">
                    <label for="content"><strong>News Content</strong></label>
                ...
                <div class="frame">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="slug" id="slug" required value="{{old('slug') ?? $news->slug}}" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_title" id="meta_title" required value="{{old('meta_title') ?? $news->meta_title}}" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" required value="{{old('meta_keywords') ?? $news->meta_keywords}}" class="form-control">
                    </div>
