...
@section('content')
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="m-4 m-md-5 mt-5">
            ...
            <form action="/dashboard/resources" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                                ...
                                <select name="type" required id="type" data-value="{{ old('type') }}" class="form-control">
                    ...
                    <div class="col-md-6">
                        <div class="card p-4">
                            <div class="form-group d-flex flex-column">
                                ...
                                <input type="file" name="img_thumb" id="img_thumb" value="{{old('img_thumb')}}" required>
                            </div>
