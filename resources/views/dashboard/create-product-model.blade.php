...
@section('content')
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="m-4 m-md-5 mt-5">
            ...
            <form action="/dashboard/product-model" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" required id="title" value="{{old('name')}}" class="form-control">
                          </div>
                          <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_application_category_id" required id="productApplicationCategory" class="form-control">
                              ...
                              @foreach ($product_application_categories as $product_application_category)
                                <option value="{{$product_application_category->id}}">{{$product_application_category->name}}</option>
                              @endforeach
                        </select>
                        </div>
                        ...
                        @foreach($containments as $containment)
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="{{Str::slug($containment->name)}}" id="{{$containment->name}}" value="1">
                                <label class="form-check-label" for="{{$containment->name}}">{{$containment->name}}</label>
                            </div>
                        @endforeach
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="tab-pane fade {{$index == 0? 'active show':'' }}" id="{{$productSpecification->title}}" role="tabpanel" aria-labelledby="home-tab">
                            <div class="form-group mt-4">
                                ...
                                <textarea class="summernote" name="{{$productSpecification->title}}">
                                    {{ old($productSpecification->title) }}
                                </textarea>
                            </div>
                        </div>
                        @endforeach
                                    ...
                                    <div class="col-md-4">
                                        @foreach($chunk as $product_brochure)
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="{{Str::slug($product_brochure->title)}}" id="{{Str::slug($product_brochure->title)}}" value="1">
                                ...
                                @foreach($product_list->chunk(15) as $chunk)
                                    ...
                                    <div class="col-md-4">
                                        @foreach($chunk as $product_rel)
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="{{Str::slug($product_rel->name)}}" id="{{Str::slug($product_rel->name)}}" value="1">
                ...
                <div class="frame">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="slug" required id="slug" value="{{old('slug') }}" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_title" required id="meta_title" value="{{old('meta_title') }}" class="form-control">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <textarea  type="text" name="meta_description" required id="meta_description" class="form-control" rows="3">{{old('meta_description')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_keywords" required id="meta_keywords" value="{{old('meta_keywords')}}" class="form-control">
                    </div>
