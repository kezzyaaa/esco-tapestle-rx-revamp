    ...
    <div class="breadcumb-area bg-img">
        <div class="page-banner-background-image" style="background-image: url('/images/banner-images/{{$Breadcrumb_banner}}');"></div>
            ...
            <div class="row align-items-end">
                <div class="col-12">
                    <div class="breadcumb-text">
                        <p class="title pb-2">{{$page_title}}</p>
                        <p class="text-white"><a class="text-white" href="/"><i class="fa fa-home" aria-hidden="true"></i></a> &rsaquo; <a class="text-white" href="/{!! Request::segment(1) !!}">{{ucfirst($breadcrumb_section)}}</a> &rsaquo;<span class=""> {{$breadcrumb_name}}</span></p>
                    </div>
                </div>
            </div>
        </div>
