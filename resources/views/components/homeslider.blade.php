        ...
        <div class="slide slide-{{$slider->sort}} {{($slider->sort == '0') ? 'active' : ''}}">
            ...
            <div class="slide__content">
                ...
                <div class="slide__text">
                    <div class="container">
                        <div>
                            <div class="col-lg-6 col-md-8" style="background: rgba(0, 70, 127, 0.7); border-radius: 10px; padding: 20px; max-width: 650px;">
                                <!--  <p style="color: white;" class="pt-4">Seminar on</p>
                                <hr> -->
                                <h1 class="slide__text-heading pt-4">{{$slider->title}}</h1>
                                <p class="slide__text-desc pt-2">{{$slider->details}}</p>
                                <a class="slide__text-link mb-4" data-toggle="modal" data-target="#slider{{$slider->sort}}">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></i></a>
                            </div>
                        </div>
