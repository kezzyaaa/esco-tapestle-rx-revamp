<head>
    ...
    <title>@yield('title',$config->meta_title)</title>
    <meta name="description" content="@yield('meta_description',$config->meta_description)">

    <meta name="keywords" content="@yield('meta_keywords',$config->meta_keywords)">
    <meta name="author" content="@yield('meta_author',$config->meta_author)">
    <meta name="copyright" content="@yield('meta_copyright',$config->meta_copyright)">
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('images/core-img/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('images/core-img/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/core-img/favicon-16x16.png') }}">
    <link rel="manifest" href="{{ asset('images/core-img/site.webmanifest') }}">
    <link rel="mask-icon" href="{{ asset('images/core-img/safari-pinned-tab.svg') }}" color="#5bbad5">
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('images/core-img/escopharma-favicon.ico') }}">
    ...
    <link href="{{ asset('css/app.css') }}?v=10.26" rel="stylesheet">
</head>
