            ...
            <div class="col-lg-7 border-right border-secondary">
                <div class="row">
                    <div class="col-12">
                        <div class="footer-logo-details">
                            ...
                            <p>TaPestle Rx is the division of Esco
                                Healthcare that specializes in healthcare
                                facility and laboratory construction</p>
                        </div>
                ...
                <div class="row mt-4">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <p><a href="{{$footerproduct->path()}}">{{$footerproduct->name}}</a></p>
                                    </li>
                    ...
                    <div class="col-md-3 mt-5 mt-sm-0 pl-4">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <p><a href="{{url("/customer-service/conditions-of-supply")}}">Conditions of Supply</a></p>
                            </li>
                            <li>
                                <p><a href="{{url("/customer-service/terms-and-conditions")}}">Terms and Conditions</a></p>
                            </li>
                            <li>
                                <p><a href="{{url("/customer-service/data-privacy-policy")}}">Privacy Policy</a></p>
                            </li>
                        </ul>
