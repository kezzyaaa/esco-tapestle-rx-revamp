...
@include('components/covid-popup')
...
<div class="h-100 d-flex flex-column justify-content-center">
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card shadow-sm border-0" style="border-radius: 0; background: transparent">
                <div class="card-body" style="padding: 0;">
                    <div class="row" style="width: 100%; margin-left: 0;">
                        <div class="col-lg-6" style="height: 50vh; padding: 0">
...
<section class="cta-area bg-img">
    ...
    <div class="container py-0 py-sm-3 h-100">


        <div class="h-100 py-5 d-flex flex-column justify-content-center">
            <!-- Cta Content -->
            <div class=" wow fadeInUp">
                <h3><span class="teal-color ">Who we are</h3>
                <div class="d-flex">
                                    ...
                                    <div class="row">
                                                ...
                                                @foreach($Containment_controls as $Containment_control)
                                                    ...
                                                    <div class="d-flex pb-3 align-items-center wow fadeInRight" data-wow-delay="0.5s">
                                                        <div class="containment-contorls-img">
                                                            <a href="{{url("/products")}}"><img  src="/images/misc-img/containment-controls-large/{{$Containment_control->img_large}}" alt="{{$Containment_control->name}}" title="{{$Containment_control->name}}"></a>

                                                        </div>
                                                        <div class="pl-3 containment-contorls-details">
                                                        <a href="{{url("/products")}}"><p class="text-uppercase m-0"><strong>{{$Containment_control->name}}</strong></p></a>
                                                        <p class=" m-0">{{$Containment_control->description}}</p>
                                                        </div>
                                                    </div>
                                                @endforeach
                                        ...
                                        <div class="col-lg-6">
                                            <div  class="containment-contorls-right p-2 px-md-5 py-md-2 mt-3 mt-sm-2">
                                                <a href="{{url("/solutions/oel-oeb")}}"><img class="px-2 px-md-5 wow fadeInUp lazy" data-src="/images/misc-img/CM-Symbol-green-01-min.png" alt="oel-oeb containment map" title="oel-oeb containment map" data-wow-delay="0.5s"></a>
                    ...
                    <div class="row pt-1 pt-sm-5 d-flex  align-items-center">
                        ...
                        <div class="col-xl-6 col-md-6 col-10 offset-md-0 offset-1 mt-4 mt-sm-4">
                            <div class="feature-product-slider feature-product-slider-owl owl-carousel bg-img d-flex align-items-center"  style="background-image: url(images/upload/product-slider-green-bg-min.png); background-size: 100% 100%;">
                                    <div class="container">
                                        <a href="{{url("/products/cell-processing-isolator/19")}}"><img data-src="/images/product-images/full-image/home-slider-cell-processing-isolator-min.png" class="img-fluid pb-3 slider-image lazy" title="Cell Processing Isolator (CPI)" alt="Cell Processing Isolator (CPI)"></a>
                                    ...
                                    <div class="container">
                                        <a href="{{url("/products/gmp-compliant-radioisotope-dispensing-isolator/39")}}"><img data-src="/images/product-images/full-image/home-radiopharmacy-isolator-min.png" class="img-fluid pb-3 slider-image lazy" title="Radiopharmacy isolator" alt="Radiopharmacy isolator"></a>
                    ...
                    <div class="row pt-1 pt-sm-5 d-flex  align-items-center">
                        ...
                        <div class="col-xl-6 col-md-6 col-10 offset-md-0 offset-1 mt-4 mt-sm-4">
                            <div class="feature-product-slider standard-configurable-product-slider owl-carousel bg-img d-flex align-items-center"  style="background-image: url(images/upload/product-slider-gray-bg-min.png); background-size: 100% 100%;">
                                    ...
                                    <div class="container">
                                        <a href="{{url("/products/laminar-flow-straddle-units/5")}}"><img data-src="/images/product-images/full-image/home-slider-lf-stradle-unit-min.png" class="img-fluid pb-3 slider-image lazy" title="Esco Enterprise Laminar Flow Straddle Units (Single/Double)" alt="Esco Enterprise Laminar Flow Straddle Units (Single/Double)"></a>
                                    ...
                                    <div class="container">
                                        <a href="{{url("/products/healthcare-platform-isolator-with-filter-below-workzone/22")}}"><img data-src="/images/product-images/full-image/home-slider-healthcare-platform-min.png" class="img-fluid pb-3 slider-image lazy" title="Isoclean Healthcare Platform Isolator" alt="Isoclean Healthcare Platform Isolator"></a>
                                        <p data-animation="fadeInUp" class=" text-center">Isoclean<sup>&reg;</sup> Healthcare Platform Isolator</p>
                                    </div>

                                    <div class="container">
                                        <a href="{{url("/products/turbulent-flow-aseptic-isolator/28")}}"><img data-src="/images/product-images/full-image/home-slider-turbulent-flow-aseptic-isolator-min.png" class="img-fluid pb-3 slider-image lazy" title="Turbulent Flow Aseptic Isolator" alt="Turbulent Flow Aseptic Isolator"></a>
                    ...
                    <div class="row pt-1 pt-sm-5 d-flex  align-items-center">
                        ...
                        <div class="col-xl-6 col-md-6 col-10 offset-md-0 offset-1 mt-4 mt-sm-4">
                            <div class="feature-product-slider custom-tailored-product-slider owl-carousel bg-img d-flex align-items-center"  style="background-image: url(images/upload/product-slider-green-bg-min.png); background-size: 100% 100%; ">
                                    ...
                                    <div class="container">
                                        <a href="{{url("/products/biobooth/37")}}"><img data-src="/images/product-images/full-image/home-slider-biobooth-powder-coated-min.png" class="img-fluid pb-3 slider-image lazy" title="Esco BioBooth™" alt="Esco BioBooth™"></a>
                                        <p data-animation="fadeInUp" class=" text-center">BioBooth&trade;</p>
                                    </div>


                                    <div class="container">
                                        <a href="{{url("/products/downflow-booths/3")}}"><img data-src="/images/product-images/full-image/home-slider-downflow-booths-min.png" class="img-fluid pb-3 slider-image lazy" title="Downflow Booth" alt="Downflow Booth"></a>
                            ...
                            <div id="cf7_controls" class="">
                                ...
                                <div class="cf7_controls-img-details">
                                                    ...
                                                    <div class="opaque solutions-content " style="display: flex;height: 100%; background-color: #48AFB5; align-items: center;  justify-content: center;">
                                                     ...
                                                     @foreach($activeSolutionSel->children as $activeSolutionChild)
                                                        <div class="solutions-content solutions-content-index" style="height: 100%;">
                                                            <img data-src="/images/misc-img/solution-icons/{{$activeSolutionChild->icon}}" class="lazy" alt="{{$activeSolutionChild->title}}" />
                                                            <p class="px-4">{{\Illuminate\Support\Str::limit($activeSolutionChild->details, 160, $end='...')}}</p>
                                    ...
                                    <div class="hoverable-solutions hover-sol-left">
                                        @foreach($activeSolutionSel->childrenFirstHalf as $activeSolutionChild)
                                            <p data-solution-count="{{$loop->index}}">{{$activeSolutionChild->title}}</p>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="hoverable-solutions hover-sol-right">
                                        @foreach($activeSolutionSel->childrenSecondHalf as $activeSolutionChild)
                                            <p data-solution-count="{{$loop->index + 10}}">{{$activeSolutionChild->title}}</p>
                                        @endforeach
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="stock-units-tab-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex flex-column justify-content-center">
                                        ...
                                        <a href="{{url("/products/downflow-booths/3")}}" class="pharma-btn text-center">READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
        ...
        <div class=" py-5 d-flex flex-column justify-content-center">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class=" pr-5">
                            <h3 class="smaller-title">{{$eventsTitle}}</h3>
                        </div>
                                ...
                                <div class="event-item row mt-4">
                                    <div class="col-4">
                                        <div class="event-date">
                                            <h6 class="text-center text-white">{{$upcomingevent->event_start->format("M")}}<br><span class="font-weight-bold event-day">{{$upcomingevent->event_start->format("d")}}-{{$upcomingevent->event_end->format("d")}}</span></h6>
                                        </div>
                                    </div>
                                    <div class="col-8 d-flex align-items-center">
                                        <div>
                                            <h6>{{$upcomingevent->title}}</h6>
                                            <p class="secondary-text-color"><i class="fa fa-map-marker" aria-hidden="true"></i> {{$upcomingevent->location}}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                            <a href="{{url("/events")}}" class="pharma-btn">VIEW MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="news-list-home">
                            <div class="row">
                                <div class="col-12">
                                    <div class="main-news">
                                        <h6 class="news-category-title">{{$newscategories[0]->title}}</h6>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a href="{{$newscategories[0]->news->sortByDesc('created_at')->first()->path()}}"><img data-src="/images/news-banner/thumb/{{$newscategories[0]->news->sortByDesc('created_at')->first()->banner_thumb}}" class="custom-light-box-shadow lazy"></a>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="new-details">
                                                    <a href="{{$newscategories[0]->news->sortByDesc('created_at')->first()->path()}}"><h6 class="news-title mt-2 mt-sm-2">{{$newscategories[0]->news->sortByDesc('created_at')->first()->title}}</h6></a>
                                                    <p class="mb-0 secondary-text-color">{{$newscategories[0]->news->sortByDesc('created_at')->first()->description}}</p>
                                                    <a href="{{$newscategories[0]->news->sortByDesc('created_at')->first()->path()}}" class="pharma-btn">READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="main-news">
                                        <h6 class="news-category-title">{{$newscategories[1]->title}}</h6>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="{{$newscategories[1]->news->sortByDesc('created_at')->first()->path()}}"><img data-src="/images/news-banner/thumb/{{$newscategories[1]->news->sortByDesc('created_at')->first()->banner_thumb}}" class="custom-light-box-shadow lazy"></a>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="new-details">
                                                    <a href="{{$newscategories[1]->news->sortByDesc('created_at')->first()->path()}}"><h6 class="news-title mt-2 mt-sm-2">{{$newscategories[1]->news->sortByDesc('created_at')->first()->title}}</h6></a>
                                                    <p class="mb-0 secondary-text-color">{{$newscategories[1]->news->sortByDesc('created_at')->first()->description}}</p>
                                                    <a href="{{$newscategories[1]->news->sortByDesc('created_at')->first()->path()}}" class="pharma-btn">READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="main-news">
                                        <h6 class="news-category-title">{{$newscategories[2]->title}}</h6>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="{{$newscategories[2]->news->sortByDesc('created_at')->first()->path()}}"><img data-src="/images/news-banner/thumb/{{$newscategories[2]->news->sortByDesc('created_at')->first()->banner_thumb}}" class="custom-light-box-shadow lazy"></a>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="new-details">
                                                    <a href="{{$newscategories[2]->news->sortByDesc('created_at')->first()->path()}}"><h6 class="news-title mt-2 mt-sm-2">{{$newscategories[2]->news->sortByDesc('created_at')->first()->title}}</h6></a>
                                                    <p class="mb-0 secondary-text-color">{{$newscategories[2]->news->sortByDesc('created_at')->first()->description}}</p>
                                                    <a href="{{$newscategories[2]->news->sortByDesc('created_at')->first()->path()}}" class="pharma-btn">READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<section>
    <div class="container">
        <div class=" pt-3 pb-5 d-flex flex-column justify-content-center">
            <!-- Cta Content -->
            <div class=" pr-5">
                <a href="#">
