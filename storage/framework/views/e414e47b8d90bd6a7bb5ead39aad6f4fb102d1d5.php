    ...
    <?php echo $__env->make('components/footerCarousel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components/footerNewsletter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <footer style="color: #FFF !important; background-color: #48AFB5; background-image: url('/images/bg-img/footer-bg-01.svg'); background-position: bottom center; background-repeat:no-repeat;">
                ...
                <div class="col-lg-7 border-right border-secondary">
                    ...
                    <div class="row mt-4">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <ul class="list-unstyled">
                                        <?php $__currentLoopData = $footerproducts->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footerproduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><p><a href="<?php echo e($footerproduct->path()); ?>"><?php echo e($footerproduct->name); ?></a></p></li>
                                            <?php if($loop->iteration == 15): ?>
                                                    </ul>
                                                </div>
                                                <div class="col-6">
                                                    <ul class="list-unstyled">
                        ...
                        <div class="col-md-3 mt-5 mt-sm-0 pl-4">
                            ...
                            <ul class="list-unstyled">
                                <li><p><a href="<?php echo e(url("/customer-service/conditions-of-supply")); ?>">Conditions of Supply</a></p></li>
                                <li><p><a href="<?php echo e(url("/customer-service/terms-and-conditions")); ?>">Terms and Conditions</a></p></li>
                                <li><p><a href="<?php echo e(url("/customer-service/data-privacy-policy")); ?>">Privacy Policy</a></p></li>
                            </ul>
...
<?php /**PATH C:\xampp\htdocs\esco-tapestle-rx-revamp\resources\views/includes/footer.blade.php ENDPATH**/ ?>