...
<body>
	...
	<section class="cta-area bg-img pb-5 page-background">
		<div class="container d-lg-flex flex-md-row-reverse align-items-stretch">
			...
			<?php echo $__env->make('includes.contactus_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\esco-tapestle-rx-revamp\resources\views/layouts/contactUspageView.blade.php ENDPATH**/ ?>