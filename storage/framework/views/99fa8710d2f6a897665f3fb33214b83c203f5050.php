                    ...
                    <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul style="font-weight: bold;">
                                    <li class="<?php echo e(Request::is('about*') ? 'active' : ''); ?>"><a href="/about/profile" style="color: #FFF">ABOUT US</a>
                                      <ul class="dropdown">
                                    ...
                                    <li class="<?php echo e(Request::is('products*') ? 'active' : ''); ?>"><a href="/products" style="color: #FFF">PRODUCTS</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="<?php echo e(Request::is('solutions*') ? 'active' : ''); ?>"><a href="/solutions/by-application" style="color: #FFF">SOLUTIONS</a>
                                        <ul class="dropdown">
                                    ...
                                    <li class="<?php echo e(Request::is('services*') ? 'active' : ''); ?>"><a href="/services/nebb-cleanroom-performance-testing" style="color: #FFF">SERVICES</a>
                                        <ul class="dropdown">
                                    ...
                                    <li class="<?php echo e(Request::is('news*') ? 'active' : ''); ?>"><a href="/news" style="color: #FFF">NEWS</a></li>
                                    <li class="<?php echo e(Request::is('resource*') ? 'active' : ''); ?>"><a href="/resource/technical-references" style="color: #FFF">RESOURCES</a>
                                        <ul class="dropdown">
                                    ...
                                    <li class="<?php echo e(Request::is('contact-us*') ? 'active' : ''); ?>"><a href="/contact-us/" style="color: #FFF">CONTACT US</a></li>
